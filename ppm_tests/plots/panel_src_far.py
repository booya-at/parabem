...
import ppm
from ppm.pan3d import src_3_0_n0
...
y = []
for xi in x:
    trg1 = ppm.Vector3(xi, 0, 0.0)
    trg2 = ppm.Vector3(xi, 0, 0.5)
    trg3 = ppm.Vector3(xi, 0, 1)
...
y = []
for xi in x:
    trg1 = ppm.Vector3(0, xi, 0.0)
    trg2 = ppm.Vector3(0, xi, 0.5)
    trg3 = ppm.Vector3(0, xi, 1)
    val1 = src_3_0_n0(trg1, source)
    val2 = src_3_0_n0(trg2, source)
    val3 = src_3_0_n0(trg3, source)
    y.append([val1, val2, val3])
...
y = []
for xi in x:
    trg1 = ppm.Vector3(0, 0, xi)
    trg2 = ppm.Vector3(0.5, 0, xi)
    trg3 = ppm.Vector3(1, 0, xi)
    val1 = src_3_0_n0(trg1, source)
    val2 = src_3_0_n0(trg2, source)
    val3 = src_3_0_n0(trg3, source)
    y.append([val1, val2, val3])
